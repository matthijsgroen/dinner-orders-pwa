...
const plugins = [
    ...
    new HTML({template: 'src/index.html', inject: false, minify: isProd ? {
        removeComments: true,
        collapseWhitespace: true
      } : false}),
    new HTML({template: 'src/static/manifest.json', filename: 'manifest.json', minify: false, inject: false}),
...
module.exports = {
    ...
    module: {
      ...
      {
        test: /\.scss$/,
        loader: isProd ? extractOtherCss.extract({
      ...
      {
        test: /shell.scss$/,
        loader: isProd ? extractShellCss.extract({
